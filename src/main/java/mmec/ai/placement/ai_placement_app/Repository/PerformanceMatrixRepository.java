...
@Query(value ="select sub_name,attempt_no,score,Cat_1,Cat_2,Cat_3,Cat_4,Cat_5,Cat_6,Cat_7 from performancematrix where usn=:usn",nativeQuery = true)
    public List<StudentScores> findScoresByusn(String usn);

    @Query(value ="select usn,sub_name,attempt_no,score,quiz_date,timetaken,Cat_1,Cat_2,Cat_3,Cat_4,Cat_5,Cat_6,Cat_7 from performancematrix where usn=:usn",nativeQuery = true)
    public List<StudentScores> findAllScoresByusn(String usn);

    @Query(value ="select usn,sub_name,attempt_no,score,quiz_date,timetaken,Cat_1,Cat_2,Cat_3,Cat_4,Cat_5,Cat_6,Cat_7 from performancematrix where usn=:usn and attempt_no=:attemptNo",nativeQuery = true)
    public List<StudentScores> findAllScoresByusnandAttemptno(String usn, Integer attemptNo);

    @Query(value ="select usn,sub_name,attempt_no,score,quiz_date,timetaken,Cat_1,Cat_2,Cat_3,Cat_4,Cat_5,Cat_6,Cat_7 from performancematrix where usn=:usn and sub_name='Apti'",nativeQuery = true)
    public List<StudentScores> getAptiscoreByUsn(String usn);

    @Query(value ="select usn,sub_name,attempt_no,score,quiz_date,timetaken,Cat_1,Cat_2,Cat_3,Cat_4,Cat_5,Cat_6,Cat_7 from performancematrix where usn=:usn and sub_name='Program-Skill'",nativeQuery = true)
    ...
    @Query(value ="select usn,sub_name,attempt_no,score,quiz_date,timetaken,Cat_1,Cat_2,Cat_3,Cat_4,Cat_5,Cat_6,Cat_7 from performancematrix where usn=:usn and sub_name=:scode",nativeQuery = true)
